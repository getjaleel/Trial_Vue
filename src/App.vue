...
<p style="text-align: left; padding-left: 40px;"><span class="x_ui-provider">&nbsp; &nbsp; &nbsp;</span><span class="x_ui-provider"><strong>How&nbsp;do&nbsp;I&nbsp;submit&nbsp;my&nbsp;data&nbsp;-&nbsp;Help&nbsp;Guides</strong></span><span class="x_ui-provider">&nbsp;</span></p>
...
<p style="text-align: left; padding-left: 40px;"><span class="x_ui-provider">This includes links to useful software (and guides) for connecting to AWS s3 buckets</span></p>
<p style="text-align: left; padding-left: 40px;">&nbsp;</p>
<p style="text-align: left; padding-left: 40px;">&nbsp; &nbsp; &nbsp; <span class="x_ui-provider"><strong>What&nbsp;data&nbsp;and&nbsp;formats&nbsp;-&nbsp;Product&nbsp;Specifications</strong></span><span class="x_ui-provider">&nbsp;</span></p>
...
<p class="x_MsoListParagraph" style="text-align: left; padding-left: 40px;">&nbsp;</p>
