  ...
  >
    ...
    <template v-slot="{ user, signOut }">
      <h1>Hi {{ user.username }}!</h1>
        ...
        <p>&nbsp;</p>
<p style="text-align: left; padding-left: 80px;">Congratulations! You have successfully generated a new secure storage bucket and you will soon receive an email with additional credentials.</p>
<p style="text-align: left; padding-left: 80px;">In the meantime please find some useful links that should help you get started.</p>
